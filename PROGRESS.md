...
- Released: **v0.35.1**. Version arc v0.1.0 → v0.35.1 in one month
  ...
  went the way it did.
- v0.35.0/v0.35.1 make delivery part of the completion contract: required branches
  ...
  before either the target branch or release tag is published.
